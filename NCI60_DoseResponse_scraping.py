...
NSC_list = pd.read_csv('/home/anhvu/vu_data/thesis/raw_benchmark/filtered_DoseResponse_2016.csv')

smiles_list = open('/home/anhvu/vu_data/thesis/raw_benchmark/DoseResponse_SMILES.csv','w')
